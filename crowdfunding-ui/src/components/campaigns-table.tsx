        ...
        <Card key={key} className="m-3" style={{ width: "18rem" }}>
          ...
          <Card.Body>
            ...
            <div className="flex flex-wrap">
              <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#campaign</span>
              <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#donations</span>
            </div>
            <div className="mt-4 flex justify-between">
              ...
              <p className="font-bold text-xl mb-2">
                Donated: {(c.account.amountDonated / web3.LAMPORTS_PER_SOL).toString()}
              </p>
            </div>
